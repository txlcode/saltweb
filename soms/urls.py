...
urlpatterns = [
    ...
    url(r'^deploy/flush_module/$', dviews.salt_flush_module, name='flush_module'),
    url(r'^deploy/module/upload/$', dviews.UploadFile.as_view(), name='module_upload'),
    ...
    url(r'^deploy/task_running/$', dviews.salt_task_running1, name='task_running'),
    url(r'^deploy/task_stop/$', dviews.salt_task_stop, name='task_stop'),
