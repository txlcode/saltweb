# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-12-12 03:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attchment', models.FileField(blank=True, null=True, storage=deploy.storage.FileStorage(), upload_to='salt/module/3nrxGWVbeqrGAyj7sp8HxQ7v6UjUpvQWSqrD9DR3c3WJwpqxEQ6YrgNgF8pjxHpPRUjJpHpnjj8y7MVu', verbose_name='\u6a21\u5757\u4e0a\u4f20')),
