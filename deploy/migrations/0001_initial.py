# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2019-01-22 02:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attchment', models.FileField(blank=True, null=True, storage=deploy.storage.FileStorage(), upload_to='salt/module/JleRyRKUHk9d8U9Ymp3V6tqpaBx9jMvuTWsyhtnTrHyqTwLsFgnRKGNLUKQYJk8H8eNRp65CK6Sdfks7', verbose_name='\u6a21\u5757\u4e0a\u4f20')),
